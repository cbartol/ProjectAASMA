...
<Characteristics(ContainerCapacity:=20, _
  ...
  Public Class Collector
    ...
    Public Const SquadNumber As Integer = 2
    ...
    Private m_WhatToDoNext As WhatToDoNextAction = WhatToDoNextAction.MoveToAZN
